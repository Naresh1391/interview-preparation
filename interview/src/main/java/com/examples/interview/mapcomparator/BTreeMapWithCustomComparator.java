...
// Tree map is used for sorting,we can't pass the comparator anonymous class or 
//java8 function to hashmap.. so we nned to use tree to sort out

public class BTreeMapWithCustomComparator {
